...
@export var drying_time:float = 2 ## Time the blod drop will start drying, usually slow
...
func _ready():
	...
	#print("Scales set: ", _mat.get_shader_parameter("scales"))
	#print("Positions set: ", _mat.get_shader_parameter("positions"))
